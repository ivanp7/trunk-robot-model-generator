function setup_RRRP(block_name, parameters, segment_config_data)

if isfield(parameters, 'piston_mass')
    piston_mass = parameters.piston_mass;
else
    piston_mass = segment_config_data.mechanism_mass/2;
end
...
cylinder_inertia = (segment_config_data.mechanism_mass - piston_mass) * ...
    (segment_config_data.mechanism_height^2 * [1/12 0 0; 0 1/12 0; 0 0 0] + ...
